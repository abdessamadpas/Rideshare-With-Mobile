...
SetCarpoolingInfo
    ...
    React.useEffect(() => {
        ...
        SetCarpoolingInfo(carpoolingInfo)
                        ...
                        <View style={{ flex: 1, marginLeft: SIZES.padding }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    />
                                    <Text style={{ ...FONTS.body3 }}>{carpoolingInfo?.rating}</Text>
                                </View>
                            </View>

                            <Text style={{ color: COLORS.darkgray, ...FONTS.body4 }}>{carpoolingInfo?.name}</Text>
                        </View>
                    </View>
